CLASS LHC_ZI_ERRORCODE010_S DEFINITION FINAL INHERITING FROM CL_ABAP_BEHAVIOR_HANDLER.
  PRIVATE SECTION.
    METHODS:
      AUGMENT_ERRORCODE010 FOR MODIFY
        IMPORTING
          ENTITIES_CREATE FOR CREATE ErrorCode010All\_ErrorCode010
          ENTITIES_UPDATE FOR UPDATE ErrorCode010.
ENDCLASS.

CLASS LHC_ZI_ERRORCODE010_S IMPLEMENTATION.
  METHOD AUGMENT_ERRORCODE010.
    DATA: text_for_new_entity      TYPE TABLE FOR CREATE ZI_ErrorCode010\_ErrorCode010Text,
          text_for_existing_entity TYPE TABLE FOR CREATE ZI_ErrorCode010\_ErrorCode010Text,
          text_update              TYPE TABLE FOR UPDATE ZI_ErrorCode010Text.
    ...
    DATA: text_tky_link  TYPE STRUCTURE FOR READ LINK ZI_ErrorCode010\_ErrorCode010Text,
    ...
    LOOP AT entities_create INTO DATA(entity).
      ...
      ENDLOOP.
    ENDLOOP.
    MODIFY AUGMENTING ENTITIES OF ZI_ErrorCode010_S
      ENTITY ErrorCode010
        CREATE BY \_ErrorCode010Text
        FROM text_for_new_entity
        RELATING TO entities_create BY relates_create.

    IF entities_update IS NOT INITIAL.
      READ ENTITIES OF ZI_ErrorCode010_S
